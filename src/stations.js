export const taxiStations = {
  ogilvie_union: {
    name: "Ogilvie/Union (West Loop)",
    coordinates: [
      41.88224963761097,
      -87.63860020208031
    ],
    mapsLink: "https://goo.gl/maps/58X5WBvWvwK2oeeZA",
    color: "#277bb3",
    textColor: "#fff",
    to: {
      michigan: {
  ...
  michigan: {
    name: "Michigan Avenue (Wrigley Building)",
    coordinates: [
      41.88929991088218,
      -87.62521941056612
    ],
    mapsLink: "https://goo.gl/maps/DuRcudUVJ4VeAo4y8",
    color: "#4fd5fc",
    textColor: "#181a1b",
    to: {
      ogilvie_union: {
  ...
  chinatown: {
    ...
    mapsLink: "https://goo.gl/maps/Ab9v3b5uFuzSuier8",
    color: "#522298",
    textColor: "#fff",
    to: {
      ogilvie_union: {
